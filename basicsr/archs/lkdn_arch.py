...
from basicsr.archs.lkdn_blocks import LKDB, StarConv,SelfConv, BSConvU, BSConvU_ks, BSConvU_idt, BSConvU_rep, UpsampleOneStep, Upsampler_rep
...
class LKDN(nn.Module):
    ...
    def __init__(self,
        ...
        elif conv == 'BSConvU_ks':
            self.conv = BSConvU_ks
        elif conv == 'BSConvU':
            self.conv = BSConvU
        elif conv == 'StarConv':
            self.conv = StarConv
