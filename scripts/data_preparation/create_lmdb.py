...
def create_lmdb_for_div2k():
    ...
    """
    # HR images
    folder_path = '/home/hfw/data/SR/DIV2K/DF2K_train/HR_sub'
    lmdb_path = '/home/hfw/data/SR/DIV2K/DF2K_train/HR_sub.lmdb'
    ...
    # LRx4 images
    folder_path = '/home/hfw/data/SR/DIV2K/DF2K_train/LR/X4_sub'
    lmdb_path = '/home/hfw/data/SR/DIV2K/DF2K_train/LR/X4_sub.lmdb'
    img_path_list, keys = prepare_keys_div2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
...
def create_lmdb_for_df2k():
    ...
    Usage:
        ...
        Typically, there are four folders to be processed for DF2K dataset.
            ...
            * DF2K_train_HR_sub
            * DF2K_train_LR_bicubic/X2_sub
            * DF2K_train_LR_bicubic/X3_sub
            * DF2K_train_LR_bicubic/X4_sub

        Remember to modify opt confi
        gurations according to your settings.
    """
    # HR images
    folder_path = '/home/hfw/data/SR/DIV2K/DF2K_train/HR_sub'
    lmdb_path = '/home/hfw/data/SR/DIV2K/DF2K_train/HR_sub.lmdb'
    ...
    # LRx2 images
    folder_path = '/home/hfw/data/SR/DIV2K/DF2K_train/LR/X2_sub'
    lmdb_path = '/home/hfw/data/SR/DIV2K/DF2K_train/LR/X2_sub.lmdb'
    img_path_list, keys = prepare_keys_df2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)

    # LRx3 images
    folder_path = '/home/hfw/data/SR/DIV2K/DF2K_train/LR/X3_sub'
    lmdb_path = '/home/hfw/data/SR/DIV2K/DF2K_train/LR/X3_sub.lmdb'
    img_path_list, keys = prepare_keys_df2k(folder_path)
    make_lmdb_from_imgs(folder_path, lmdb_path, img_path_list, keys)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, help=("Options: 'DF2K', 'DIV2K', 'REDS', 'Vimeo90K'"))
